function [R_approx,V_approx,P_a_approx, Optimal_policy_approx] = approx_blahut_arimoto(Ps, Q, beta_vals, num_action_samples, P_a_approx_init, sample_with_replacement, resample_every_beta, N_counts)
    % Ps: P(s); |S| x 1 vector.
